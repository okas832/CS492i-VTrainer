...
from custom_dataset import image_dataset, Resizer, Normalizer, RandomFlip, collater
import pdb
def parse_args():
...
def main():
    ...
    train_loader = DataLoader(dataset=train_dataset, batch_size=args.batch_size,shuffle=True, num_workers=4, collate_fn=collater)
